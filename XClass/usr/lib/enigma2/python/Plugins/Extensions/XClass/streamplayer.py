...
class XClassCueSheetSupport:
    ...
    def __init__(self):
        ...
        self.started = False
        self.resume_point = ""
        if not os.path.exists("/etc/enigma2/xclass/resumepoints.pkl"):
            with open("/etc/enigma2/xclass/resumepoints.pkl", "w"):
                pass
...
class XClass_VodPlayer(
    InfoBarBase,
    IPTVInfoBarShowHide,
    IPTVInfoBarPVRState,
    XClassCueSheetSupport,
    InfoBarMenu,
    InfoBarAudioSelection,
    InfoBarNotifications,
    InfoBarSeek,
    ...
    def __init__(self, session, streamurl, servicetype, direct_source=None, stream_id=None):
        ...
        try:
            XClassCueSheetSupport.__init__(self)
        except Exception as e:
            print(e)
